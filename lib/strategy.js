...
function Strategy(options, verify) {
  ...
  var useExtendedUserInfo = (options.scope || []).find(function(s) { return s === 'direct.users.me.readonly'; }) != undefined;
  var directUserInfoURL = 'https://api.direct4b.com/albero-app-server/users/me' + (useExtendedUserInfo ? '' : '/openIdConnect');
  ...
  options.userInfoURL      = options.userInfoURL      || directUserInfoURL;

  // profile converter
  var conv;
  if (useExtendedUserInfo) {
    conv = function(profile) {
